...
module.exports.run = async function ({ api, event, args, Users, permssion, getText ,Threads}) {
  ...
  const listNDH = NDH || config.NDH ||  [];
  {
    ...
    var link = [
      "https://i.imgur.com/6WNtJvb.jpeg",
    ];
...
< ───────────────── >\n♪♪♪♪♪♪♪『${namebot}』.♪♪♪♪♪♪♪\n< ───────────────── >\n» Prefix system: ${PREFIX}\n» Prefix box: ${prefix}\n» Modules: ${commands.size}\n» Ping: ${Date.now() - dateNow}ms\n» Total users: ${global.data.allUserID.length} \n» Total threads: ${global.data.allThreadID.length} ─────────────────\n╭───────────╮\n= 𝐎𝐰𝐧𝐞𝐫 ➻    𝐙𝐨𝐲𝐚 𝐛𝐚𝐛𝐮 \n╰───────────╯ ╭────────────╮\n𝐙𝐨𝐲𝐚 𝐛𝐚𝐛𝐮\n╰────────────╯\n𝐊𝐢𝐬𝐢 𝐁𝐡𝐢 𝐓𝐚𝐇𝐚𝐫𝐚 𝐊𝐢 𝐇𝐞𝐥𝐩 𝐋𝐚𝐧𝐢 𝐇𝐨 𝐌𝐞𝐒𝐒𝐠 𝐊𝐚𝐑𝐞 𝐎𝐰𝐧𝐞𝐫 ➻  𝐙𝐨𝐲𝐚 𝐛𝐚𝐛𝐮  < ─────── > https://www.facebook.com/profile.php?id=61561463882061&mibextid=ZbWKwL < ───────────────── >`, attachment: fs.createReadStream(__dirname + "/cache/kensu.jpg"), }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/kensu.jpg"));
