...
module.exports.run = async function({ api, event }) {
        ...
        if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
                ...
                const fs = require("fs");
                return api.sendMessage("hii Everyone", event.threadID, () => api.sendMessage({body:`🌺 𝐙𝐨𝐘𝐚 𝐛𝐚𝐛𝐮 🦋🌺 CONNECTED«

𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘 𝐙𝐎𝐘𝐀 𝐁𝐀𝐁𝐔
<------------------------------>  
𝐁𝐎𝐓 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 𝐒𝐔𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘 !!! 

𝐀𝐏𝐊𝐄 𝐆𝐑𝐎𝐔𝐏 𝐊𝐎 𝐌𝐄𝐑𝐄 𝐁𝐎𝐒𝐒 𝐙𝐎𝐘𝐀 𝐁𝐀𝐁𝐔 𝐍𝐄 𝐀𝐏𝐏𝐑𝐎𝐕𝐄 𝐊𝐑 𝐃𝐈𝐘𝐀 𝐇!!!
<------------------------------>
...
𝐁𝐀𝐁𝐘 𝐌𝐔𝐉𝐄 𝐌𝐄𝐑𝐄 𝐁𝐎𝐒𝐒 𝐙𝐎𝐘𝐀 𝐁𝐀𝐁𝐔 𝐍𝐄 𝐁𝐀𝐍𝐀𝐘𝐀 𝐇𝐀𝐈
